...
This project is a PsychoPy implementation of a child-friendly fish flanker, with three additions on top of the basic design:
 ...
 3. An end-of-session feedback dashboard computes the participant's personal flanker effect and presents their results in understandable , nonclinical, and clear language.

## Experimental Design
### Variables
### Independent variables:
 1. Orientation congruency (congruent vs. incongruent) —> the standard flanker manipulation
 2. Color match (target color same as vs. different from flankers) —>  a within-trial distractor that varies in proportion across blocks
